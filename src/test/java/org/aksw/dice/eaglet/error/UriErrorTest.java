...
public class UriErrorTest extends AbstractErrorTest {
	...
	public void setUp() throws Exception {
		...
		expectedResults.add(new ErrorType[] { ErrorType.INVALIDURIERR, ErrorType.INVALIDURIERR, ErrorType.INVALIDURIERR,
				ErrorType.NOERROR, ErrorType.NOERROR, ErrorType.INVALIDURIERR });
		...
		expectedResults.add(new ErrorType[] { ErrorType.DISAMBIGURIERR });
		...
		doc.add(new DocumentImpl("China is a large country.",
				...
				Arrays.asList((Marking) new NamedEntityCorrections(0, 5,
						"http://dbpedia.org/resource/People's_Republic_of_China"))));
		expectedResults.add(new ErrorType[] { ErrorType.OUTDATEDURIERR });
		partner_list.add(new NamedEntityCorrections[] { null });
	}
