package org.aksw.gscheck.completion.Test;
...
public class MissingEntityCompletionTest {
	...
	public MissingEntityCompletionTest(List<Document> documents, List<Document> expectedDocuments,
	...
	public void test() throws GerbilException {
		...
		GoldStandardCompletion test_var = new MissingEntityCompletion(annotators);
