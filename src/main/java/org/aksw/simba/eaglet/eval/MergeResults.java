...
public class MergeResults {
    ...
    private void merge(Document resultDocument, Document userDocument) {
        Set<EntityCheck> resultEntities = new HashSet<EntityCheck>(resultDocument.getMarkings(EntityCheck.class));
        List<EntityCheck> userEntities = userDocument.getMarkings(EntityCheck.class);
        for (EntityCheck e : userEntities) {
