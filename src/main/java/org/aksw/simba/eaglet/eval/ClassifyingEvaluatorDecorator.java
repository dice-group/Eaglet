 ...
 */
public class ClassifyingEvaluatorDecorator extends
		AbstractTypeTransformingEvaluatorDecorator<NamedEntityCorrections, ClassifiedEntityCheck> {
	...
	protected List<ClassifiedEntityCheck> changeType(List<NamedEntityCorrections> markings) {
