...
public class CheckerPipeline {
    ...
    public static final String PIPE_CONFIG_KEY = "org.aksw.simba.eaglet.errorcheckpipeline.CheckerPipeline.pipe";
    public static final String POST_USER_PIPE_CONFIG_KEY = "org.aksw.simba.eaglet.errorcheckpipeline.CheckerPipeline.postUserPipe";
    public static final String ANNOTATORS_LIST_KEY = "org.aksw.simba.eaglet.errorcheckpipeline.CheckerPipeline.annotators";
    ...
    public List<ErrorChecker> setupPipe() throws GerbilException {
        return createPipe(GerbilConfiguration.getInstance().getStringArray(PIPE_CONFIG_KEY));
    }
